...
INSERT INTO productos (nombre, precio, create_at) VALUES('Sony Camara digital DSC-W320B', 123490, CURRENT_TIMESTAMP();
INSERT INTO productos (nombre, precio, create_at) VALUES('Apple iPod shuffle', 1499990, CURRENT_TIMESTAMP();
INSERT INTO productos (nombre, precio, create_at) VALUES('Sony Notebook Z110', 37990, CURRENT_TIMESTAMP();
INSERT INTO productos (nombre, precio, create_at) VALUES('Hewlett Packard Multifuncional F2280', 69990, CURRENT_TIMESTAMP));
INSERT INTO productos (nombre, precio, create_at) VALUES('Bianchi Bicicleta Aro 26', 69990, CURRENT_TIMESTAMP();
INSERT INTO productos (nombre, precio, create_at) VALUES('Mica Comoda 5 Cajones', 299990, CURRENT_TIMESTAMP();
...
INSERT INTO facturas (descripcion, observacion, cliente_id, create_at) VALUES('Factura Bicicleta', 'Alguna nota importante!', 1, CURRENT_TIMESTAMP();
